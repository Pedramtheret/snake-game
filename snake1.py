...
class game:
    ...
    def estimate_util(self, snake_body, screen):
        ...
        for direction in possible_direction:
            ...
            if self.snake.is_safe(snake_copy, new_head):
                ...
                rect=pygame.Rect((int(new_head.x)*self.snake.tile_W) + self.snake.Board_margin,
                ...
                if self.estimate_util(snake_copy, screen):
                    return True
                snake_copy=snake_body[:]
            new_head=snake_copy[0]
            ...
            for event in pygame.event.get():
                ...
                if event.type ==self.move_event:
                    if self.snake.body[0]==self.fruit.pos :
                        ...
                        self.estimate_util(self.snake.body, self.screen)
                        self.snake.move() 
            #updates
